...
| M4 | Skills / MCP 骨架 | `skills` | `skills` | 开发中（PR1 文档 + PR2 后端：/mcp 双 token 中间件 + skill_invocations 留痕 + GET /skills/invocations + 回填 workitem-skill；前端待建） | [skills.md](modules/skills.md) |
