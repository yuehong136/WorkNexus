...
class ErrorCode(IntEnum):
    ...
    # 3xxx: intake
    INTAKE_NOT_FOUND = 3001
    INTAKE_NOT_ACTIONABLE = 3002
    INTAKE_DUPLICATE_TARGET_INVALID = 3003
    # 4xxx: identity
    ...
    # 7xxx: workchat / agent actions
    CONVERSATION_NOT_FOUND = 7001
    AGENT_ACTION_NOT_FOUND = 7002
    AGENT_ACTION_NOT_PENDING = 7003
    AGENT_ACTION_EXPIRED = 7004
    AI_PLATFORM_UNAVAILABLE = 7005
    AI_RUN_FAILED = 7006
    WORKCHAT_RUN_NOT_FOUND = 7007
